...
import {TPropertyPayment } from "@/types";
...
import {
  useGetAgentAllPropertyPaymentsQuery,
  useGetAllPropertyPaymentsQuery,
} from "@/redux/api/features/property/propertyPaymentApi";
export default function AdminPropertyPayment() {
  ...
  const { data, isFetching } = useGetAgentAllPropertyPaymentsQuery({
    userId: user?._id,
    query: queryString,
  });
