...
import { ImageDown, Play } from 'lucide-react'
...
>
   ...
   <h3 className="text-3xl text-white text-center font-bold mb-2">About Our Company</h3>
      ...
      <div className="grid lg:grid-cols-2 gap-20 items-center">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 text-gray-700">
            <p>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum odio id
              voluptatibus incidunt cum? Atque quasi eum debitis optio ab. Esse itaque officiis
              tempora possimus odio rerum aperiam ratione, sunt.
            </p>
