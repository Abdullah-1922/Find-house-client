...
const BlogCard = () => {
    const articles = [
      ...
      
        {
          ...
          image: "https://code-theme.com/html/findhouses/images/blog/b-8.jpg"
        },
        {
          id: 5,
          title: "All Places In Town",
          ...
          image: "https://code-theme.com/html/findhouses/images/blog/b-7.jpg"
        },
        {
            id: 6,
            title: "All Places In Town",
            ...
            image: "https://code-theme.com/html/findhouses/images/blog/b-9.jpg"
          }
      ];
    return (
        <div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-8">
        {articles.map((article) => (
          <div key={article.id} className="max-w-[340px] bg-white shadow-lg rounded-lg overflow-hidden">
            <Image
              src={article.image}
              alt={article.title}
              width={400}
