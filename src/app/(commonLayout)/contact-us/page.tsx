...
import ProperLocation from "../_components/module/propertyDetails/propertyLocation";
...
const ContactUs  = () => {
    ...
    return (
     <div className="">
           <div   className="max-h-[300px] py-36"
        style={{
          backgroundImage: `
 ...
 <div className="container mx-auto px-4 py-8">
      <div className="grid gap-20 lg:grid-cols-2">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url("https://code-theme.com/html/findhouses/images/bg/bg-testimonials.jpg")',
            backgroundSize: 'cover',
            backgroundPosition: 'center'
          }}
        >
