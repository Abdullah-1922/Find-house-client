...
const locations = [
    {
      name: 'New York City',
      propertiesCount: 203,
      image: 'https://code-theme.com/html/findhouses/images/popular-places/12.jpg',
      isFeatured: true,
    },
    {
      name: 'Los Angeles',
      propertiesCount: 150,
      image: 'https://code-theme.com/html/findhouses/images/popular-places/11.jpg',
      isFeatured: false,
    },
    {
      name: 'Chicago',
      propertiesCount: 75,
      image: 'https://code-theme.com/html/findhouses/images/popular-places/10.jpg',
      isFeatured: true,
    },
    {
      name: 'Miami',
    ...
    <div>
     ...
     <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
      {locations.map((location, index) => (
        <div key={index} className="max-w-sm overflow-hidden rounded-lg shadow-lg group">
          <a href="#" className="block relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white transition-opacity duration-300 group-hover:opacity-100">
              ...
              <p className="mt-2 text-sm">{location.propertiesCount} Properties</p>
