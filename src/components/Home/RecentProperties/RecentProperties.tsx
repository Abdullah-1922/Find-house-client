...
const RecentProperties = () => {
  const properties = [
    { title: "Family Apartment", price: "$230,000", beds: 6, baths: 3, sqft: 720 },
    { title: "Luxury Villa", price: "$450,000", beds: 5, baths: 4, sqft: 850 },
    { title: "Modern Condo", price: "$180,000", beds: 3, baths: 2, sqft: 600 },
    { title: "Suburban House", price: "$320,000", beds: 4, baths: 3, sqft: 780 },
    { title: "Beach House", price: "$550,000", beds: 4, baths: 3, sqft: 900 },
    { title: "Mountain Cabin", price: "$275,000", beds: 3, baths: 2, sqft: 650 },
  ]
  return (
    <div
      className=" h-[700px]"
              ...
              <div className="relative w-[300px] overflow-hidden rounded-lg shadow-lg">
                <div className="relative h-[400px]">
                  <Image
                    ...
                    src={`https://code-theme.com/html/findhouses/images/interior/p-${index + 1}.jpg`}
                  />
