    ...
    <h1 className="logo">
      ...
      <div className='flex justify-center items-center gap-5'>
        <div className='flex justify-center gap-x-2 items-center'>
          <Image className='w-5' src={languageLogo } alt='world svg for language' width={1000} height={1000}/>
        <h2 className='font-bold border-r border-gray-700 pr-5 text-gray-600'>ENG</h2>
        </div>
      ...
      <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar flex justify-center items-center w-36">
        ...
        <h3 tabIndex={0} role="button" className='text-gray-500 text-sm'>Hi, Mary <i className="fas fa-caret-right text-gray-500"></i></h3>
      </div>
